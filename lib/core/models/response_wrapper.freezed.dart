...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ResponseWrapper<T>&&const DeepCollectionEquality().equals(other.data, data));
}
...
class _ResponseWrapper<T> implements ResponseWrapper<T> {
  const _ResponseWrapper({required this.data});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _ResponseWrapper<T>&&const DeepCollectionEquality().equals(other.data, data));
}
