...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function( T body)?  success,TResult Function( CustomException error)?  error,required TResult orElse(),}) {final _that = this;
switch (_that) {
case Success() when success != null:
return success(_that.body);case Error() when error != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function( T body)  success,required TResult Function( CustomException error)  error,}) {final _that = this;
switch (_that) {
case Success():
return success(_that.body);case Error():
return error(_that.error);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function( T body)?  success,TResult? Function( CustomException error)?  error,}) {final _that = this;
switch (_that) {
case Success() when success != null:
return success(_that.body);case Error() when error != null:
return error(_that.error);case _:
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Success<T>&&const DeepCollectionEquality().equals(other.body, body));
}
...
/// Create a copy of Result
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? body = freezed,}) {
  return _then(Success<T>(
freezed == body ? _self.body : body // ignore: cast_nullable_to_non_nullable
as T,
  ));
}
...
$CustomExceptionCopyWith<$Res> get error {
  ...
  return $CustomExceptionCopyWith<$Res>(_self.error, (value) {
