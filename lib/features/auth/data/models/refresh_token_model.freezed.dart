...
@JsonKey(name: 'jwt') String get accessToken;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is RefreshTokenModel&&(identical(other.accessToken, accessToken) || other.accessToken == accessToken));
}
...
@override
String toString() {
  return 'RefreshTokenModel(accessToken: $accessToken)';
}
...
@useResult
$Res call({
@JsonKey(name: 'jwt') String accessToken
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(name: 'jwt')  String accessToken)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _RefreshTokenModel() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(name: 'jwt')  String accessToken)  $default,) {final _that = this;
switch (_that) {
case _RefreshTokenModel():
return $default(_that.accessToken);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(name: 'jwt')  String accessToken)?  $default,) {final _that = this;
switch (_that) {
case _RefreshTokenModel() when $default != null:
return $default(_that.accessToken);case _:
  return null;
...
class _RefreshTokenModel extends RefreshTokenModel {
  const _RefreshTokenModel({@JsonKey(name: 'jwt') required this.accessToken}): super._();
  factory _RefreshTokenModel.fromJson(Map<String, dynamic> json) => _$RefreshTokenModelFromJson(json);

@override@JsonKey(name: 'jwt') final  String accessToken;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _RefreshTokenModel&&(identical(other.accessToken, accessToken) || other.accessToken == accessToken));
}
